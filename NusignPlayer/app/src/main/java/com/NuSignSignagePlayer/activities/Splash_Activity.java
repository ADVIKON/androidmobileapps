...
import com.NuSignSignagePlayer.mediamanager.AdditionalSongsRemovalTask;
...
import com.NuSignSignagePlayer.utils.FirebaseIDService;
...
public class Splash_Activity extends Activity implements ConnectivityReceiver.ConnectivityReceiverListener,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_splashportrait);
