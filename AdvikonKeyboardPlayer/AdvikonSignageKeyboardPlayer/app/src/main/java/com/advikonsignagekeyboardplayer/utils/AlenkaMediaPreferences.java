...
public class AlenkaMediaPreferences {
    ...
    public static final String isDemoToken = "isDemoToken";
    public static final String totalShotsCount = "totalShotsCount";
    public static final String tankAlertPercentages = "tankAlertPercentages";
