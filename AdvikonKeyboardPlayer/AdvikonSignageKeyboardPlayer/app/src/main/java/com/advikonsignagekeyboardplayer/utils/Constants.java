...
public class Constants {
 ...
 public static final String DB_TYPE = "Advikon";

 public static final String CHECK_USER_LOGIN = SERVER + "AppLogin";//DeviceId,TokenNo,UserName Old CheckUserLoginLive
 ...
 public static final String ANNOUNCEMENTS = SERVER + "GetMachineAnnouncement";
 public static final int ANNOUNCEMENTS_TAG = 17;

 public static final String ANNOUNCEMENT_LOGS = SERVER + "MachineEventLogs";
 public static final int ANNOUNCEMENT_LOGS_TAG = 18;


 public static final String TANK_STATUS_REMINDER = SERVER + "DispenserAlertMail";
 public static final int TANK_STATUS_REMINDER_TAG = 19;

 public static final String UPDATE_FCM = SERVER + "UpdateFCMId";
 public static final int UPDATE_FCM_TAG = 20;
 ...
 public static final String ANNOUNCEMENTS_FOLDER = "Announcements";
